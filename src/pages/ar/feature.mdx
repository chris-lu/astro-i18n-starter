...
تتكون صفحة الخطأ 404 في ... من ملفين. إذا كنت ترغب في تخصيص تصميم صفحة الخطأ 404، يكفي تحرير الملف `src/pages/[lang]/404.astro` فقط.
...
عندما يتم الوصول إلى هذا الملف في ...، سيتم إعادة توجيه المستخدم إلى صفحة الخطأ 404 المناسبة وفقًا للغة النظام وما إلى ذلك.
...
لذلك، يرجى ملاحظة أنه في ...، يتم تعريف الكود التالي داخل ملف `src/styles/base.css`:
...
في ...، نستخدم [Material Icon](https://fonts.google.com/icons)، ويتم تعريف الكود التالي داخل ملف `src/styles/base.css`:
